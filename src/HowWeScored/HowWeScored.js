  ...
  <div>
    <div style={styles.wrapper}>
      ...
      <p style={{ maxWidth: '700px' }}>
        ...
        based on how their answers align with the mission of Generation Zero. To
        more fully understand the scoring breakdown and why candidates received
        the rating they did, have a look below to find examples of both high and
        low scoring answers for each question.
      </p>
    </div>
    <Transport />
    <UrbanForm />
